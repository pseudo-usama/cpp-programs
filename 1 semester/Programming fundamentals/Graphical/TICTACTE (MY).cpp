...
void main()
{
	...
	for(;; counter++) {
		...
		else if(selector=='1') { if(data[0][0]==1||data[0][0]==2) goto cba; i=x/2-100; j=y/2-100; data[0][0]=p; }
		else if(selector=='2') { if(data[0][1]==1||data[0][1]==2) goto cba; i=x/2    ; j=y/2-100; data[0][1]=p; }
		else if(selector=='3') { if(data[0][2]==1||data[0][2]==2) goto cba; i=x/2+100; j=y/2-100; data[0][2]=p; }
		else if(selector=='4') { if(data[1][0]==1||data[1][0]==2) goto cba; i=x/2-100; j=y/2    ; data[1][0]=p; }
		else if(selector=='5') { if(data[1][1]==1||data[1][1]==2) goto cba; i=x/2    ; j=y/2    ; data[1][1]=p; }
		else if(selector=='6') { if(data[1][2]==1||data[1][2]==2) goto cba; i=x/2+100; j=y/2    ; data[1][2]=p; }
		else if(selector=='7') { if(data[2][0]==1||data[2][0]==2) goto cba; i=x/2-100; j=y/2+100; data[2][0]=p; }
		else if(selector=='8') { if(data[2][1]==1||data[2][1]==2) goto cba; i=x/2    ; j=y/2+100; data[2][1]=p; }
		else if(selector=='9') { if(data[2][2]==1||data[2][2]==2) goto cba; i=x/2+100; j=y/2+100; data[2][2]=p; }
		else {
			cba:
